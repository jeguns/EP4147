...
# 2. Una empresa consigue un financiamiento de 15 mil soles, el cual será liquidado durante 10 meses al inicio de cada uno de estos, a una tasa de 2% mensual. ¿Cuál es el valor de cada prestación?
...
# 5. Una persona invierte 2800 soles al inicio de cada año, durante 2 años. Considerando una TEA de 1%, ¿Cuál es el monto final resultante de la inversión?

fv.annuity(r = 0.01, n = 2, pmt = -2800, type = 1) # anticipado

2800*(1+0.01)^2 + 2800*(1+0.01)

# 6. Asuma el caso anterior pero los pagos se realizan durante 15 años. Determine el valor futuro.

fv.annuity(r = 0.01, n = 15, pmt = -2800, type = 1) 

# 7. Una persona realiza un depósito de 5000 soles durante todos los meses de diciembre durante desde el año 2001 hasta el año 2016, a un tasa de interés del 6% anual. Decide retirar su dinero en diciembre de 2017. ¿Cuál será el monto a ser retirado?
